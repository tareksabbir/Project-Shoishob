...
export default function EmailCollect() {
  return (
    <div className="max-w-7xl mx-auto relative bg-nearest-rgb-23-32-49 ">
      <section className="relative ">
        <section className="text-gray-600 body-font bg-nearest-rgb-23-32-49">
          <div className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 className="title-font sm:text-4xl lg:text-4xl mb-4 font-extrabold bg-gradient-to-r from-cyan-400 to-purple-500 text-transparent bg-clip-text">
                Learn more about us
              </h1>
              <p className="mb-8 leading-relaxed text-gray-400">
                Your curiosity is important to us, and we are here to provide
                you with the insights you seek.
              </p>
              <div className="flex w-full md:justify-start justify-center items-end">
                <div className="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
                  ...
                  <input
                    ...
                    id="hero-field"
                    name="hero-field"
                    className="w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-sm outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                  />
                </div>
