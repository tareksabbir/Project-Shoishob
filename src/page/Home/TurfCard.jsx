...
const TurfCard = ({ turf }) => {
  const { logo, turf_name, address } = turf;
  return (
    <>
      <div className="p-1 lg:w-1/5 md:w-1/3 w-1/2">
        <div className="h-full items-center bg-gray-800  p-6 rounded-lg">
          <img
            alt="team"
          ...
          <div className="flex-grow text-center">
            ...
            <Link className="bg-gradient-to-r from-cyan-400 to-purple-400 text-transparent bg-clip-text px-3 py-1 text-xs ">
              See More
            </Link>
          </div>
        </div>
