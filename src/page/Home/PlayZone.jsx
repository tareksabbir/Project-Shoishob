        ...
        <div className="container px-5 py-20 mx-auto flex flex-wrap">
          <div className="flex w-full mb-20 flex-wrap">
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 lg:w-1/3 lg:mb-0 mb-4">
              Enlightening Moments In Our Sport Zones
            </h1>
            <p className="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base">
              Experience enlightening moments in our sport zones, where passion,
              skill, and camaraderie converge. From exhilarating matches to
              awe-inspiring performances, our sport zones provide a platform for
              unforgettable moments of triumph, teamwork, and personal growth.
              Embrace the joy and fulfillment of sporting excellence in our
