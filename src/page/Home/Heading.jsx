      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <h1 className="sm:text-3xl lg:text-4xl text-3xl font-bold title-font mb-4 text-gray-900">
          ...
          <div className="flex flex-wrap">
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
              ...
              <p className="leading-relaxed text-base mb-4">
                Our leader board facility allows you to track and compare your
                progress with others, fostering a spirit of healthy competition
                and motivation.
              </p>
