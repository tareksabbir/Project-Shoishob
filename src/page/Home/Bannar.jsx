...
import hero from "../../assets/images/homepage-gb-hero_short.png";
      ...
      <section className=" flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16 lg:px-20 px-10">
        <div className="xl:w-11/12 flex flex-col justify-center items-center lg:items-start sm:text-center lg:text-left lg:py-8 xl:py-10">
          ...
          <p className="lg:w-4/5 text-gray-500 xl:text-lg leading-relaxed mb-8 md:mb-12">
            seize the moment and embrace the possibilities that lie before you.
            Opportunities come and go, fleeting like shooting stars across the
            night sky. Its in those moments of decision, when you choose to act,
            that greatness is born.
          </p>
          <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
            <Link
              to="/"
              className="inline-block bg-indigo-500 hover:bg-gradient-to-r from-black to-indigo-500 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3"
            >
              Book now
            </Link>
      ...
      <section className="lg:mt-5 flex flex-col lg:flex-row justify-between items-center border-t gap-10 lg:gap-8 pt-8 lg:px-24">
        <div className="grid grid-cols-2 md:flex md:divide-x gap-4 -mx-6 md:-mx-8">
          <div className="px-6 md:px-8">
            <span className="block text-primary text-lg md:text-xl font-bold text-center md:text-left">
