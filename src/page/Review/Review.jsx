...
import { Star, ThumbsUp, ThumbsDown, Filter, Search, Plus, User, MapPin, Trophy, Heart, Calendar, Award, Target, Users, Sparkles, ChevronDown, ArrowDown, Play } from 'lucide-react';
...
const ReviewPage = () => {
  const [reviews, setReviews] = useState([
    {
      ...
      content: "My 8-year-old son has been participating in SHOISHOB tournaments for 3 months now. The improvement in his confidence and social skills is remarkable! He's made so many friends and actually asks to go outside and play instead of being glued to his tablet. The zones are well-maintained and safe.",
      helpful: 24,
      notHelpful: 1,
      verified: true,
      parentReview: true,
    ...
    },
    {
      ...
      content: "As a parent, I was worried about my daughter's excessive screen time. SHOISHOB has been a game-changer! She now spends 2-3 hours daily in physical activities. The app's gamification features motivate her to stay active. Highly recommend to all parents!",
      helpful: 18,
      notHelpful: 0,
      verified: true,
      parentReview: true,
    ...
    },
    {
      ...
      content: "The badminton tournaments are so much fun! I've made lots of new friends and my coach says I'm getting really good. The app shows my progress and I love collecting points. Can't wait for the next tournament!",
      helpful: 31,
      notHelpful: 2,
      verified: true,
      parentReview: false,
    ...
    },
    {
      ...
      content: "SHOISHOB is addressing a real problem in our society. My twin boys (age 10) have become more active and healthier. The concept is excellent, though I'd like to see more variety in sports offered. The community aspect is wonderful - kids are learning teamwork and leadership.",
      helpful: 15,
      notHelpful: 3,
      verified: true,
      parentReview: true,
    ...
    },
    {
      ...
      content: "I used to spend 8+ hours gaming daily. Now I'm captain of my zone's basketball team! My parents are so proud and I feel much stronger and confident. The app tracking system is cool and helps me set goals.",
      helpful: 28,
      notHelpful: 1,
      verified: true,
      parentReview: false,
    ...
    },
    {
      ...
      content: "My shy 9-year-old daughter has blossomed since joining SHOISHOB activities. She's more confident, has better communication skills, and her physical health has improved significantly. The coaches are patient and encouraging.",
      helpful: 12,
      notHelpful: 1,
      verified: true,
      parentReview: true,
    ...
    },
    {
      ...
      content: "Football practice is the best part of my day now! I've learned teamwork and made best friends. My stamina has improved a lot and I sleep better at night. Thank you SHOISHOB for making sports so fun!",
      helpful: 22,
      notHelpful: 0,
      verified: true,
      parentReview: false,
    ...
    },
    {
      ...
      content: "The idea is brilliant and my son loves it, but the nearest zone is quite far from our area. Hope they expand to more locations soon. The activities are well-organized and safe.",
      helpful: 9,
      notHelpful: 4,
      verified: true,
      parentReview: true,
  ...
  const stats = useMemo(() => {
    ...
    const parentReviews = reviews.filter(review => review.parentReview).length;
    const childReviews = reviews.filter(review => !review.parentReview).length;

    return { totalReviews, averageRating, ratingCounts, parentReviews, childReviews };
  }, [reviews]);
    ...
    return (
      <div className="flex items-center gap-0.5">
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            key={star}
            className={`${size} transition-all duration-200 ${star <= rating ? 'fill-amber-400 text-amber-400 drop-shadow-sm' : 'text-slate-600'}`}
          />
        ))}
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-violet-600/20 to-purple-600/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-600/10 to-cyan-600/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 mb-32">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-400 text-lg mt-1">Transforming screen addiction into sports passion</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="group relative bg-gradient-to-br from-emerald-500/10 to-teal-500/10 backdrop-blur-sm p-6 rounded-xl border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 hover:scale-105">
                ...
                <div className="relative z-10 text-center">
                  <div className="flex items-center justify-center mb-3">
                    ...
                    <div className="text-3xl font-bold text-emerald-400">{stats.averageRating.toFixed(1)}</div>
                  </div>
              ...
              <div className="group relative bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-sm p-6 rounded-xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:scale-105">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="text-sm text-slate-400 font-medium">Total Reviews</div>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-purple-500/10 to-violet-500/10 backdrop-blur-sm p-6 rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:scale-105">
                ...
                <div className="relative z-10 text-center">
                  <div className="flex items-center justify-center mb-3">
                    ...
                    <div className="text-3xl font-bold text-purple-400">{stats.parentReviews}</div>
                  </div>
                  <div className="text-sm text-slate-400 font-medium">Parent Reviews</div>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-orange-500/10 to-amber-500/10 backdrop-blur-sm p-6 rounded-xl border border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 hover:scale-105">
                ...
                <div className="relative z-10 text-center">
                  <div className="flex items-center justify-center mb-3">
                    ...
                    <div className="text-3xl font-bold text-orange-400">{stats.childReviews}</div>
                  </div>
                  <div className="text-sm text-slate-400 font-medium">Child Reviews</div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                {[5, 4, 3, 2, 1].map((rating, index) => (
                  <div key={rating} className="flex items-center gap-4 group">
                    <span className="text-sm font-medium w-4 text-slate-300">{rating}</span>
                    ...
                    <div className="flex-1 bg-slate-700/50 rounded-full h-2.5 overflow-hidden">
                      <div 
                        ...
                        style={{ 
                          width: `${(stats.ratingCounts[index] / stats.totalReviews) * 100}%`,
                          animationDelay: `${index * 0.1}s`
                        }}
                      ></div>
                    </div>
                    <span className="text-sm text-slate-400 w-8 font-medium">{stats.ratingCounts[index]}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {filteredReviews.map((review, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-6">
                ...
                <h4 className="font-semibold text-xl text-white mb-3 leading-tight">{review.title}</h4>
                <p className="text-slate-300 mb-6 leading-relaxed text-base">{review.content}</p>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-600/50">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      ...
                      <span className="text-sm font-medium">Not Helpful ({review.notHelpful})</span>
                    </button>
                  </div>
                  
                  <div className="flex items-center gap-2 text-xs text-slate-500">
                    <Users className="w-3 h-3" />
                    <span>{review.helpful + review.notHelpful} people found this review helpful</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {filteredReviews.length === 0 && (
          <div className="text-center py-16 bg-gradient-to-br from-slate-800/90 via-slate-800/95 to-slate-900/90 backdrop-blur-xl rounded-2xl shadow-xl border border-slate-700/50">
            ...
            <h3 className="text-2xl font-semibold text-slate-300 mb-3">No reviews found</h3>
            <p className="text-slate-400 mb-6 max-w-md mx-auto">
              We couldn't find any reviews matching your search criteria. Try adjusting your filters or search terms.
            </p>
            <button
              onClick={() => {
                setSearchTerm('');
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Help other families discover SHOISHOB</p>
                  </div>
                </div>
                
                <div className="bg-slate-700/30 p-6 rounded-xl border border-slate-600/30 mb-6">
                  <p className="text-slate-300 leading-relaxed">
                    Your review helps other parents and children discover how SHOISHOB can transform screen addiction into healthy, active lifestyles. Share your story and inspire our community!
                  </p>
                </div>
