...
const OwnerHome = () => {
  ...
  const data = [
    {
      name: "Bookings",
      uv: adminStat.allBookingsCount,
    },

    {
      name: "Paid",
      uv: adminStat.paidBookingCount,
    },
    {
      name: "Unpaid",
      uv: adminStat.UnPaidBookingCount,
    },
  ];
