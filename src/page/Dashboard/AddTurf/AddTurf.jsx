...
import { Upload, MapPin, DollarSign, Users, FileText, Image, Mail, User, Phone, Building } from "lucide-react";
...
const AddTurf = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.turf_name.trim()) newErrors.turf_name = "Turf name is required";
    ...
    else if (parseInt(formData.person) < 1) newErrors.person = "Must allow at least 1 person";
    if (!formData.about.trim()) newErrors.about = "About section is required";
    else if (formData.about.length > 500) newErrors.about = "Maximum 500 characters allowed";
    if (!formData.rules.trim()) newErrors.rules = "Rules section is required";
    else if (formData.rules.length > 500) newErrors.rules = "Maximum 500 characters allowed";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result) {
        ...
        showAlert("Success!", "Turf data has been saved successfully", "success");
      }
    } catch (error) {
      console.error("Error in form submission:", error);
      showAlert("Error!", "Failed to save turf data. Please try again.", "error");
    } finally {
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      />
                      {errors.turf_name && <p className={errorClasses}>{errors.turf_name}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {errors.ownerId && <p className={errorClasses}>{errors.ownerId}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      />
                      {errors.ownerPhone && <p className={errorClasses}>{errors.ownerPhone}</p>}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0"
                      />
                      {errors.person && <p className={errorClasses}>{errors.person}</p>}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 border-t border-gray-700 pt-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {errors.cover && <p className={errorClasses}>{errors.cover}</p>}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="flex justify-between items-center mt-1">
                        {errors.about && <p className={errorClasses}>{errors.about}</p>}
                        <span className="text-sm text-gray-500 ml-auto">{formData.about.length}/500</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      ></textarea>
                      <div className="flex justify-between items-center mt-1">
                        {errors.rules && <p className={errorClasses}>{errors.rules}</p>}
                        <span className="text-sm text-gray-500 ml-auto">{formData.rules.length}/500</span>
                      </div>
                    </div>
                  </div>
                </div>
