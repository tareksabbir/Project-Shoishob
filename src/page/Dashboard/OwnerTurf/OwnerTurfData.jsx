...
const {
  ...
  ["turfs", owner?._id], // Add owner._id as dependency
  async () => {
    const res = await axios.get(`${backendUrl}/api/v1/turf/owner/${owner._id}`, {
      headers: {
  ...
  {
    enabled: !!owner?._id, // Only run when owner._id exists
  }
);
