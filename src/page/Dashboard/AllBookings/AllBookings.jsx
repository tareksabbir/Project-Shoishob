...
const AllBookings = () => {
  ...
  const filteredBookings = booking.filter((book) => {
    ...
    // Status filter (you can expand this based on your booking status field)
    const statusMatch =
      filterStatus === "all" ||
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400 text-lg">Loading bookings...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            <div className="mb-6 lg:mb-0">
              <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent mb-2">
                Dashboard Overview
              </h1>
