      ...
      <div className="bg-gray-900">
        <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
            <div className="col-span-full lg:col-span-2">
              <div className="lg:-mt-2 mb-4">
                <a
                  href="/"
                  className="inline-flex items-center gap-2.5 text-2xl font-bold  md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400"
                  aria-label="logo"
                >
                  <svg
                    width="95"
          ...
          <div className="text-gray-400 text-sm text-center border-t border-gray-800 py-8">
            © 2023 - tarek sabbir. All rights reserved.
          </div>
        </footer>
      </div>
    </div>
